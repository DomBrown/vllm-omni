...
class Qwen3TTSTalkerForConditionalGeneration(nn.Module):
    ...
    def preprocess(
        ...
        **info_dict: Any,
        ...
        # Decode: span_len == 1
        with record_function_or_nullcontext("model.preprocess: decode"):
            with record_function_or_nullcontext("model.preprocess: decode: cpu_to_gpu transfers"):
                tts_pad_embed_cpu = info_dict.get("tts_pad_embed")
            ...
            with record_function_or_nullcontext("model.preprocess: decode: embed_input_ids"):
